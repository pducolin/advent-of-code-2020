from src.y2020.day_18.part_2 import evaluate_expression, solve_expression_list

EXAMPLES = [
    {'expression': '1 + 2 * 3 + 4 * 5 + 6', 'expected': 231},
    {'expression': '1 + (2 * 3) + (4 * (5 + 6))', 'expected': 51},
    {'expression': '2 * 3 + (4 * 5)', 'expected': 46},
    {'expression': '5 + (8 * 3 + 9 + 3 * 4 * 3)', 'expected': 1445},
    {'expression': '5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))', 'expected': 669060},
    {'expression': '((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2', 'expected': 23340},
]
